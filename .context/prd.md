...
├── Principal attendance dashboard (consolidated view)
...
| **Assessments** | Full CRUD lifecycle; scheduling; per-student targeting; grading; sharing; imports and optional AI assist; detailed results with PDF export |
...
| **Attendance** | Session-based; student and teacher attendance; holidays; consolidated dashboards; threshold alerts |
...
| **Comms** | Notifications (typed), announcements, feedback with principal reply (student concern category), shared documents, Canva design studio, institution-branded email signatures |
...
*Last aligned with repository structure and `prisma/schema.prisma`. Updated after full codebase audit (Apr 2026): certificate templates, Canva integration, program content, program calendar, inspection binder, student submission logs, program taxonomy, institution profile, blob storage architecture, public branding, portal switcher.*
