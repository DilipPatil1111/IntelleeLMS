...
export default function TeacherPendingActionsPage() {
  ...
  return (
    <>
      ...
      {tab === "retake" && (
        <RetakeRequestsClient apiBasePath="/api/teacher/retake-requests" role="teacher" embedded />
      )}
      {tab === "excuse" && (
        <AttendanceExcusesClient apiBasePath="/api/teacher/attendance-excuse-requests" role="teacher" embedded />
      )}
    </>
  );
}
